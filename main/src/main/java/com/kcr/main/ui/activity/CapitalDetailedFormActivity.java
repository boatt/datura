...
import com.kcr.main.other.DayAxisValueFormatter;
import com.kcr.main.other.MyAxisValueFormatter;
import com.kcr.main.other.XYMarkerView;
...
public class CapitalDetailedFormActivity extends BasicActivity implements OnChartValueSelectedListener {
    PieChart mChart;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_capital_detailed_form);
    ...
    protected String[] mParties = new String[]{
            "教育", "健康", "环境", "食品", "爱心", "饥饿", "Party G", "Party H",
    ...
    private void setData(int count, float range) {
        ...
        PieDataSet dataSet = new PieDataSet(entries, "分类例举");
    ...
    private SpannableString generateCenterSpannableText() {
        ...
        SpannableString s = new SpannableString("去向分类");
    ...
    private void setData2(int count, float range) {
        ...
        if (mChart2.getData() != null &&
            ...
            set1 = new BarDataSet(yVals1, "2018年 6月");
