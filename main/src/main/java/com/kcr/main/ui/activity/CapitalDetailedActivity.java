...
public class CapitalDetailedActivity extends BasicActivity {
    RecyclerView rvList;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_capital_detailed);
    ...
    private void initAdapter() {//BaseQuickAdapter
        ...
        mAdapter = new BaseQuickAdapter<String, BaseViewHolder>(R.layout.item_capital_detailed) {
            @Override
