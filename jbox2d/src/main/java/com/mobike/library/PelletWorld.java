...
public class PelletWorld {

    public static final String TAG = PelletWorld.class.getSimpleName();
    ...
    protected float rate = 1.36f;//放大倍率


    public PelletWorld(ViewGroup viewgroup) {
